...
- **[Adventure (1980)]({{< relref "adventure" >}})** — Pitfall's mirror image: ~30 rooms *stored* as a hand-authored map, with a general object engine on top. The first action-adventure, gaming's most famous early Easter egg, and an early case of object-oriented, data-driven design.
